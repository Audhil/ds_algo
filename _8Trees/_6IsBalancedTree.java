...
public class _6IsBalancedTree {
  ...
  private static int calcHeight(TreeNode root, boolean[] balanced) {
    if (root == null) {
      return 0;
    }
    int lH = calcHeight(root.left, balanced);
    int rH = calcHeight(root.right, balanced);
    if (Math.abs(lH - rH) > 1) {
      balanced[0] = false;
    }
  ...
  public static void main(String[] args) {
    ...
    System.out.println("yup: is balanced tree2: " + isBalancedTree2(root));
  }
}
