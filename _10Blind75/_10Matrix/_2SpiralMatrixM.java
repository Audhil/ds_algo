...
public class _2SpiralMatrixM {
  ...
  public static List<Integer> spiralOrderRevision(int[][] matrix) {
  ...
  public static void main(String[] args) {
    System.out.println(
        "yup: spiral matrix: " + spiralOrderRevision(new int[][]{{1, 2, 3}, {4, 5, 6},
            {7, 8, 9}}));  //  yup: spiral matrix: [1, 2, 3, 6, 9, 8, 7, 4, 5]

    System.out.println(
        "yup: 2nd spiral matrix: " + spiralOrderRevision(
