...
public class _7LongestConsecutiveSequenceOfNumsM {
  ...
  public static void main(String[] args) {
    System.out.println(
        "yup: longestConsecutive: " + longestConsecutive(
            new int[]{100, 4, 200, 1, 3, 2})); //  4 -> 1,2,3,4
    System.out.println(
        "yup: longestConsecutive: " + longestConsecutive(
            new int[]{0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); //  9 -> 0, 1, .... 8
    System.out.println(
        "yup: longestConsecutive_withSorting: " + longestConsecutive_withSorting(
            new int[]{100, 4, 200, 1, 3, 2})); //  4 -> 1,2,3,4
    System.out.println(
        "yup: longestConsecutive_withSorting: " + longestConsecutive_withSorting(
            new int[]{0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); //  9 -> 0, 1, .... 8
    System.out.println(
        "yup: longestConsecutive_withHashSet_Optimal: " + longestConsecutive_withHashSet_Optimal(
            new int[]{100, 4, 200, 1, 3, 2})); //  4 -> 1,2,3,4
    System.out.println(
        "yup: longestConsecutive_withHashSet_Optimal: " + longestConsecutive_withHashSet_Optimal(
            new int[]{0, 3, 7, 2, 5, 8, 4, 6, 0, 1})); //  9 -> 0, 1, .... 8
