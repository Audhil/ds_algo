...
public class _6GenerateAllBalancedParenthesis {
  ...
  private static void getBalancedParenthesisWithBackTrackingRevision(List<String> balParenthesis4,
      int n) {
    generateWithBackTracking(balParenthesis4, 0, 0, n, new String[1]);
  }

  private static void generateWithBackTracking(List<String> balParenthesis4, int openCount,
  ...
  private static void generate2(List<String> balParenthesis3,
      int openCount,
      int closeCount,
      String output,
      int n) {
  ...
  private static void generate(List<String> balParenthesis,
      int openCount,
      int closeCount,
      String output) {
